...
Integrantes: Camila Barrera y Marcelo Gálvez.

----------------------------------------------------------------------
IMPORTANTE:

 - Uno de nuestros integrantes decidio abandonar el grupo, por lo que el profesor en vista de que solo somos 2 integrantes nos permitio omitir las opciones de exportar datos y mostrar pokemones por región (opción 10)
...
Aspectos positivos y a mejorar de cada integrante:
 ...
 - Camila Barrera: Ideas rápidas para implementar funciones de varias formas. Trabaja mejor de noche, pero se desvela y termina sin dormir, mala memoria.

 - Marcelo Gálvez: Ideas creativas para solucionar problemas que impiden la funcionalidad del codigo, aun falta aprender a modularizar y nombrar variables de manera optima.  